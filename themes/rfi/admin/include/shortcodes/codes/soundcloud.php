...
add_shortcode("soundcloud", "axiom_soundcloud_shortcode");
...
function axiom_soundcloud_shortcode($atts, $content = null) {
 ...
 */
if(!function_exists("soundcloud_get_option")){
 ...
 * @return {boolean}
 */
if(!function_exists("soundcloud_booleanize")){
 ...
 * @return {boolean}
 */
if(!function_exists("soundcloud_url_has_tracklist")){
 ...
 */
if(!function_exists("soundcloud_iframe_widget")){
 ...
 */
if(!function_exists("soundcloud_flash_widget")){
...
add_filter("plugin_action_links_" . plugin_basename(__FILE__), 'axi_soundcloud_settings_link');

function axi_soundcloud_settings_link($links) {
...
/* Add admin menu */
add_action('admin_menu', 'axi_soundcloud_shortcode_options_menu');
function axi_soundcloud_shortcode_options_menu() {
...
if(!function_exists("register_soundcloud_settings")){
...
if(!function_exists("soundcloud_shortcode_options")){
