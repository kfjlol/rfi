...
/********************************************************/
	...
	function cuteslider_enqueue_content_res() {
		...
		wp_enqueue_script('cuteslider', $GLOBALS['csPluginPath'].'/js/cute.slider.js', array(), '1.1.1', TRUE );
		wp_enqueue_script('cuteslider_transitions', $GLOBALS['csPluginPath'].'/js/cute.transitions.all.js', array(), '1.1.1', TRUE );
