...
define( 'NOTIFIER_THEME_NAME', 'Lotus' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'lotus' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://demo.averta.net/themes/lotus/log/notifier.php' ); // The remote file containing the latest version of the theme and changelog
define( 'NOTIFIER_CACHE_INTERVAL', 21600 ); // The time interval for the remote file cache in the database (21600 seconds = 6 hours)
